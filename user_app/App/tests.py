...
class ReadUserTest (APITestCase):
    ...
    def setUp(self):
        self.user1 = User.objects.create(username='bablu1' , email='bablu@gmail.com' , password='bablu@123' ,
                                           ...
                                           phone_number='201233434' , street='nigdi' , zipcode='411044' , city='pune' ,
                                           state='maharashtra' ,
                                           country='india')
        ...
        self.user3 = User.objects.create(username='admin1' , email='admin1@gmail.com' , password='1234' ,
                                           ...
                                           phone_number='213223' ,street='nigdi' ,zipcode='411044' ,city='pune' ,
                                           state='Maharashtra' ,
                                           country='india')
...
class Testloginlogout ( APITestCase ):
    def setUp(self):
        ...
        self.profile = User.objects.create_user (username="salman" , password="bablu@123" ,
                                                  ...
                                                  email="salman@gmail.com" ,city="pune" ,state="maha" ,
                                                  country="india")
